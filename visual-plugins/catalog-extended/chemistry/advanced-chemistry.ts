...
export class OrganicChemistryPlugin extends BasePlugin<ChemEngineDocument> {
  constructor() {
    super(engine, {
      ...
      displayName:     pluginText("organic-chemistry-extended", "displayName", "Extended Organic Chemistry"),
      description:     pluginText("organic-chemistry-extended", "description", "Organic structures with rings, functional groups, and stereocentres. ChemFig native."),
      category:        "chemistry",
      engineId:        "chemistry-engine",
      qualityLevel:    "official-extended",
      requiredPackages: ["chemfig", "mhchem"],
      scopeWarning:    pluginText("organic-chemistry-extended", "scopeWarning", "Complex multi-ring or stereo structures may need manual ChemFig adjustment. For publication-quality structures, use ChemDraw and import as PDF."),
      blockKind:       "input",
      defaultCaption:  pluginText("organic-chemistry-extended", "defaultCaption", "Caffeine (1,3,7-trimethylxanthine) structural formula."),
...
export class ReactionMechanismsPlugin extends BasePlugin<ChemEngineDocument> {
  constructor() {
    super(engine, {
      ...
      displayName:     pluginText("reaction-mechanisms", "displayName", "Basic Reaction Mechanisms"),
      description:     pluginText("reaction-mechanisms", "description", "Reaction mechanisms including C-C bond forming reactions, substitutions, and eliminations."),
      category:        "chemistry",
      engineId:        "chemistry-engine",
      qualityLevel:    "official-extended",
      requiredPackages: ["chemfig", "mhchem"],
      scopeWarning:    pluginText("reaction-mechanisms", "scopeWarning", "Suitable for standard mechanisms in theses. Complex multi-step mechanisms with curved arrows require manual ChemFig adjustment."),
      blockKind:       "input",
      defaultCaption:  pluginText("reaction-mechanisms", "defaultCaption", "Aldol condensation: base-catalysed formation of a $\\beta$-hydroxy carbonyl compound."),
